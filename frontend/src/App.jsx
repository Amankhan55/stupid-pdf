      ...
      <footer className="footer-desktop">
        <div className="max-width-wrapper">
          <div className="footer-inner">
            ...
            {/* Right: Social Icons (GitHub, Twitter, Discord) */}
            <div className="footer-social-row">
              <a href="https://github.com/Amankhan55/stupid-pdf" target="_blank" rel="noreferrer" className="social-icon-btn" title="GitHub">
              ...
              <a href="https://discord.com" target="_blank" rel="noreferrer" className="social-icon-btn" title="Discord">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
