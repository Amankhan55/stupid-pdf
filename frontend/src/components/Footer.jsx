      ...
      <div className="footer-bottom">
        <div className="footer-left-group">
          <img
            src="/logo.png"
            alt="StupidPDF"
            style={{ width: 22, height: 22, borderRadius: 6, boxShadow: "0 0 10px rgba(62,249,167,0.3)" }}
          />
          <span className="footer-logo-text">
            Stupid<span>PDF</span>
          </span>
          <span className="footer-copyright">
            © {new Date().getFullYear()} StupidPDF. All rights reserved.
          </span>
        </div>
        ...
        <div className="footer-social-links">
          <a href="https://github.com/Amankhan55/stupid-pdf" target="_blank" rel="noreferrer" className="footer-social-btn" aria-label="GitHub">
